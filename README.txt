...
1. In your Galaxy database, you should either:
	...
	b. Create a new database user specifically for this application, who is restricted to 
	   ...
	   user should have READ-ONLY access to the following tables and columns:
...
If you have any questions, contact the author at lukejoz the most popular email service.
